...
export const VerticalTimelineElementVolunteer = (props) => {
    ...
    return(
        <VerticalTimelineElement
            ...
            <h4 className="text-left text-xl font-medium">Volunteer</h4>
...
export default VerticalTimelineElementVolunteer;