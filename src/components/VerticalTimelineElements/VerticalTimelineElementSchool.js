...
import SchoolIcon from "../VerticalTimelineIcons/School Icon.js";

export const VerticalTimelineElementSchool = (props) => {
    ...
    return(
        <VerticalTimelineElement
            ...
            <h4 className="text-left text-xl font-medium">School</h4>
...
export default VerticalTimelineElementSchool;